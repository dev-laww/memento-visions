...
func _can_handle(object: Object) -> bool:
    return object is GaeaGenerator or object is Modifier2D or object is Modifier3D or object is NoiseGeneratorData or object is NoiseCondition or object is EnemySpawnEntry
...
func _parse_begin(object: Object) -> void:
    ...
    if object is Modifier or object is NoiseCondition:
        ...
        if not object.settings:
            return
    elif object is EnemySpawnEntry:
        if not object.get("noise"):
            return
    else:
        return
